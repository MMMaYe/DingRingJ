...
description: "Anti-slop frontend skill for landing pages, portfolios, and redesigns. The agent reads the brief, infers the right design direction, and ships interfaces that do not look templated. Invoke when building marketing/landing pages, portfolios, redesigning existing frontend, or when the user asks for 'taste-skill', 'design taste', 'anti-slop frontend', or high-quality non-templated UI."
---
