  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar__nav">
        ...
        <NavLink to="/topics" className={({ isActive }) => `sidebar__nav-item${isActive ? ' sidebar__nav-item--active' : ''}`}>
          <span className="sidebar__nav-icon"><IconScrollText /></span>
          <span className="sidebar__nav-text">主题沉淀区</span>
        </NavLink>
